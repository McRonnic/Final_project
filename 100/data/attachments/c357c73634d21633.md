...
- Name: OnlinerUIdesktop.spec.ts >> Onliner UI desktop >> Registration link test
- Location: tests/OnlinerUIdesktop.spec.ts:65:8
...
Call log:
  - waiting for getByText('Зарегистрироваться на Onlíner')
